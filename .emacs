...
(global-set-key (kbd "<menu> k r") #'kill-rectangle)
...
(global-set-key (kbd "<menu> s r") #'string-rectangle)
...
(global-set-key (kbd "<menu> y r") #'yank-rectangle)
